...
-- TODO
-- create table events_json as select * from json .`${DA.paths.kafka_events}` 
DROP Table IF EXISTS events_json;
CREATE TABLE IF NOT EXISTS events_json 
(key BINARY, offset bigint, partition bigint,timestamp bigint, topic string,value string )
